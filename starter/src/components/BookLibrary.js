      ...
      <div className="list-books-content">
        <div>
          <Bookshelf
            ...
            books={tempBookList.filter(
              (book) => book.state === "currentlyReading"
            )}
          />
          <Bookshelf
            title={"Want to Read"}
            books={tempBookList.filter((book) => book.state === "wantToRead")}
          />
          <Bookshelf
            title={"Read"}
            books={tempBookList.filter((book) => book.state === "read")}
          />
        </div>
      </div>
